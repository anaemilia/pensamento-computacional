...
<svg viewBox="0 0 706 190" width="100%" style="max-width:706px" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,0)">
  ...
  <text x="115" y="152" text-anchor="middle" font-size="11" fill="#1a2733" font-family="sans-serif" font-weight="700">? choc.</text></g>
    <text x="115" y="176" text-anchor="middle" font-size="11" fill="#1a2733" font-family="sans-serif">Restam ? chocolates</text>
  </g></svg>
""")
...
# ╔═╡ 0000c004-0000-4000-8000-000000000000
@bind qtdEstoque NumberField(0:200, default=35)

# ╔═╡ 0000c005-0000-4000-8000-000000000000
@bind qtdConsumidaOntem NumberField(0:200, default=2)

# ╔═╡ 0000c006-0000-4000-8000-000000000000
@bind qtdConsumidaHoje NumberField(0:200, default=5)
...
# ╔═╡ 0000d200-0000-4000-8000-000000000000
