...
<svg viewBox="0 0 706 190" width="100%" style="max-width:706px" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,0)">
  ...
  <text x="115" y="152" text-anchor="middle" font-size="11" fill="#1a2733" font-family="sans-serif" font-weight="700">?</text></g>
    <text x="115" y="176" text-anchor="middle" font-size="11" fill="#1a2733" font-family="sans-serif">Coleção atual: ? selos</text>
  </g></svg>
""")
...
# ╔═╡ 0000c021-0000-4000-8000-000000000000
md"""
...
# ╔═╡ 0000c022-0000-4000-8000-000000000000
@bind qtdSelosGanhosHoje NumberField(0:500, default=23)

# ╔═╡ 0000c023-0000-4000-8000-000000000000
@bind qtdSelosNaColecaoAtual NumberField(0:1000, default=417)
