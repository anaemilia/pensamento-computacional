...
# ╔═╡ 0000d203-0000-4000-8000-000000000000
if @isdefined(qtdTotalComArray)
    if qtdTotalComArray == 14
        HTML("<div style='color:#1a7a3c;font-weight:600;padding:8px;background:#eaf7ee;border-radius:6px;'>✅ Isso mesmo! qtdTotalComArray = 14</div>")
    else
        HTML("<div style='color:#b3261e;font-weight:600;padding:8px;background:#fbeceb;border-radius:6px;'>❌ Ainda não — revise o cálculo de qtdTotalComArray</div>")
    end
else
    HTML("<div style='color:#8a97a3;padding:8px;'>Aguardando você definir qtdTotalComArray...</div>")
end
