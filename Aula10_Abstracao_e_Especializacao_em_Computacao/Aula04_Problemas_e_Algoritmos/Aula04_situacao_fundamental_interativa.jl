...
<svg viewBox="0 0 706 190" width="100%" style="max-width:706px" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,0)">
  ...
  <text x="115" y="152" text-anchor="middle" font-size="11" fill="#1a2733" font-family="sans-serif" font-weight="700">? fofo</text></g>
    <text x="115" y="176" text-anchor="middle" font-size="11" fill="#1a2733" font-family="sans-serif">Hoje tem ? — ganhou ?</text>
  </g></svg>
""")
...
# ╔═╡ 0000c01e-0000-4000-8000-000000000000
md"""
...
# ╔═╡ 0000c01f-0000-4000-8000-000000000000
@bind qtdFofoletesMesPassado NumberField(0:200, default=25)

# ╔═╡ 0000c020-0000-4000-8000-000000000000
@bind qtdFofoletesHoje NumberField(0:200, default=34)
