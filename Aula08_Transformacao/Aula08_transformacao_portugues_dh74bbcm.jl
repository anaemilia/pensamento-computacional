...
# ╔═╡ ef15f08d-3bb3-44fd-85e0-84ee6f9eaf66
md"""
## Versão: Portugues
...
# ╔═╡ 3f00bdc6-ec72-468d-a9aa-3d01df836a3b
md"""
**Aplicação — 8.1**

Leia uma frase com uma temperatura de 25 °C. Ao reescrevê-la em Fahrenheit, que número muda e que significado deve permanecer? Depois use a lista do exemplo.
"""
...
# ╔═╡ 3d652123-5ac5-4c6f-8222-086067c61cf7
md"""
**Aplicação — 8.2**

Classifique comprimentos fictícios de palavras [4, 6, 8] com um limiar didático de 7 letras. Explique por que tamanho não determina dificuldade ou qualidade de uma palavra.
"""
...
# ╔═╡ a69747d7-50ce-4a45-be1b-49a4b01b3498
md"""
**Aplicação — 8.3**

Conte palavras numa sequência ["texto", "voz", "texto", "verso", "texto"]. Compare a sequência e seu dicionário de frequências.
"""
...
# ╔═╡ 6d3f9f6c-2a1c-4130-92db-f5a68b9dc3f4
md"""
**Aplicação — 8.4**

Filtre comprimentos de palavras [4, 6, 8, 9] pelo critério do exemplo. Explicite que o critério é quantitativo.
"""
...
# ╔═╡ 88b81433-f31a-4b36-bef9-00700d6231fe
md"""
**Aplicação — 8.5**

Normalize frequências fictícias de palavras [10, 20, 30]. Compare as posições relativas e as contagens originais.
"""
...
# ╔═╡ d7c87242-34d8-47e6-bd28-0cc395541d68
md"""
**Aplicação — 8.6**

Associe as palavras A e B a frequências 10 e 20. Acrescente um rótulo como terceiro campo e investigue a representação dos trios.
"""
...
# ╔═╡ 507e0fcc-b195-4280-8d6d-4240df0cef91
md"""
**Aplicação — 8.7**

Reproduza quadrados e soma com contagens didáticas [1, 2, 3, 4]. Discuta por que a operação, por si só, não mede qualidade textual.
"""
...
# ╔═╡ bc23e0d8-bb72-4ab3-a825-726d83d9334a
md"""
**Aplicação — 8.8**

Segmente "o texto transforma o olhar". Conte palavras e repetições. Explore o efeito de pontuação e maiúsculas.
"""
...
# ╔═╡ 074d7f27-a992-4a74-b248-fe9b31ab87b5
md"""
**Aplicação — 8.9**

Converta frequências [1, 2, 3] em indicadores de frequência maior que 2. Explique o que se perde e por que isso não preserva o sentido de um texto.
"""
...
# ╔═╡ 3584f395-4365-439a-a7c0-09f7443874aa
md"""
**Aplicação — 8.10**

Escolha uma transformação textual e avalie sua regra, antes/depois e limites para a interpretação.
"""
...
# ╔═╡ 72ddab12-e0f5-461f-bf1c-a9779b8b81d2
md"""
**Aplicação — 8.11**

Explore o dicionário português–espanhol original. Amplie-o após investigar a chave ausente e discuta polissemia e contexto.
"""
