...
## Balas de Leandro — pensamento dedutivo (com apoio)
...
Quais são os dois números que você já conhece — o antes e o depois? Onde eles aparecem na frase?
"""
...
A quantidade de balas diminuiu do antes para o depois. Que operação matemática, aplicada ao antes e ao depois, revela quanto foi tirado?
"""
...
A operação certa é a subtração: balas antes menos balas depois. É exatamente isso que o código abaixo faz, passo a passo.
"""
...
md"""
**Pensamento Computacional em jogo — deduzir um caso a partir de uma regra geral já conhecida, com apoio a cada passo.** Execute as células de código abaixo, uma por vez.
"""

# ╔═╡ 0000b001-0000-4000-8000-000000000000
md"""
Passo 1 (usa a Dica 1): guardamos a quantidade de balas antes.
"""

# ╔═╡ 00000004-0000-4000-8000-000000000000
qtdBalasDeLeandroAntes = 10   # passo 1

# ╔═╡ 0000b002-0000-4000-8000-000000000000
md"""
Passo 2 (usa a Dica 1): guardamos a quantidade de balas depois.
"""

# ╔═╡ 00000005-0000-4000-8000-000000000000
qtdBalasDeLeandroDepois = 6   # passo 2

# ╔═╡ 0000b003-0000-4000-8000-000000000000
md"""
Passo 3 (usa as Dicas 2 e 3): reaproveitamos a regra geral "transformação = antes − depois", já conhecida, para deduzir quantas balas Lucas comeu.
"""

# ╔═╡ 00000006-0000-4000-8000-000000000000
subtracao(qtdBalasDeLeandroAntes, qtdBalasDeLeandroDepois) = qtdBalasDeLeandroAntes - qtdBalasDeLeandroDepois   # passo 3

qtdBalasComidasPorLucas = subtracao(qtdBalasDeLeandroAntes, qtdBalasDeLeandroDepois)

# ╔═╡ 0000d003-0000-4000-8000-000000000000
if @isdefined(qtdBalasComidasPorLucas)
    if qtdBalasComidasPorLucas == 4
        HTML("<div style='color:#1a7a3c;font-weight:600;padding:8px;background:#eaf7ee;border-radius:6px;'>✅ Isso mesmo! qtdBalasComidasPorLucas = 4</div>")
    else
        HTML("<div style='color:#b3261e;font-weight:600;padding:8px;background:#fbeceb;border-radius:6px;'>❌ Ainda não — revise o cálculo de qtdBalasComidasPorLucas</div>")
    end
else
    HTML("<div style='color:#8a97a3;padding:8px;'>Aguardando você definir qtdBalasComidasPorLucas...</div>")
end
