...
# escreva aqui o código para calcular qtdTotalPorSomaDireta, usando a função soma
...
# escreva aqui o código para calcular qtdTotalComArray, usando a função sum
